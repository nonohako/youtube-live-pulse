...
Last maintained: 2026-09-23 after the read-only native YouTube snapshot, pure monitor-planning and page-memory checkpoints; tray-memory priority, immediate UI disposal, compatibility gates and implementation handoff recorded. Production remains Electron v1.12.1.
